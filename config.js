...
window.LG_CONFIG = {
  ...
  // --- 平台 ---
  // 'credamo' 或 'naodao'；入口文件里的 window.LG_PLATFORM 会覆盖这里。影响结束页文案。
  PLATFORM: 'credamo',
  PLATFORM_TEXT: {
    credamo: {
    ...
    naodao: {
      d0_next: '明天研究者会在微信上把第二天的链接发给你（约 10 分钟）。明天任何时候都可以做——请睡一觉之后再来。',
      after_code: '本页完成后平台会自动记录；如未记录，把这个码发给研究者即可。'
    }
  },
