...
window.LG_CONFIG = {
  ...
  PLATFORM_TEXT: {
    credamo: {
      d0_next: '第二天的任务（约 10 分钟）从明天起一周内任何时候都可以做，越早越好；研究者会在微信上提醒你，请从 Credamo 的第二天问卷进入。',
      after_code: '请回到 Credamo 的页面，把这个码填进"完成码"一题，报酬由平台发放。'
    },
    naodao: {
      d0_next: '第二天的任务（约 10 分钟）从明天起一周内任何时候都可以做，越早越好；研究者会在微信上提醒你，请从脑岛的第二天问卷进入。',
      after_code: '请回到脑岛的页面，把这个码填进"完成码"一题，然后提交。'
    },
    tencent: {
      d0_next: '第二天的任务（约 10 分钟）从明天起一周内任何时候都可以做，越早越好；研究者会在微信上提醒你，请从腾讯问卷的第二天问卷进入。',
  ...
  D1_WINDOW_DAYS: 7,          // D+1 建议窗口：D0 后 12 小时至 7 天（程序只强制下限；间隔进入分析作协变量）
